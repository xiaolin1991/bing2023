...
https://bing.hanglinkj.com



[![img](./docs/images/demo.png)](https://bing.hanglinkj.com)
...
```bash
git clone https://github.com/xiaolin1991/bing2023.git
npm i # 推荐使用 pnpm i
npm run build
npm run start
```
...
> 复制出来的内容应该如下所示。确认格式无误后，打开 https://bing.hanglinkj.com/#dialog=%22settings%22 ，粘贴进去，点击“转成 BING_HEADER 并复制”，然后从剪切板粘贴即可得到。（你也可以先在网页上进行验证）
